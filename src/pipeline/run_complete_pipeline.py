...
# This version in one api call, give gemini the original image + the rectified img
...
def run_single_image(image_path, output_root, qa, qa_lookup):
    ...
    if qa_item is None:
        ...
        # Step 4: Gemini sees rectified images first.
        # If any answers are unknown, ask_questions_with_fallback() retries only
        # those unknown questions using the original image.
        raw_response, parsed_response, gemini_attempts = ask_gemini_with_retries(
            qa=qa,
